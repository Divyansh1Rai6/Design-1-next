    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
      <div className="bg-white text-gray-900 rounded-lg max-w-3xl w-full max-h-[85vh] overflow-y-auto relative">
        ...
        <div className="px-6 py-4 space-y-4 text-sm leading-relaxed text-gray-700">
          ...
          <p>
            Welcome to Excellence Corporation Ltd. ("Company", "we", "our", or "us"). This Privacy Policy explains how we collect, use, process, store, share, and protect information when you access or use our website, mobile application, products, or services available through our Platform. By accessing or using the Platform, you acknowledge that you have read and understood this Privacy Policy and agree to the practices described herein.
          </p>

          <h3 className="font-semibold text-base text-gray-900">1. Company Information</h3>
          <p>
            The Platform is owned and operated by Excellence Corporation Ltd., having its registered office at 123 Business Street, New York, NY 10001.
          </p>
          <p>
           For customer support, you may contact us at contact@company.com or +1 (555) 123-4567. Our GST Registration Number is [GST_NUMBER].
          </p>
          <p>
          ...
          <p>
            Users may opt out of promotional communications at any time by following the unsubscribe instructions provided in such communications or by contacting us through contact@company.com. However, transactional communications relating to orders, payments, security, and account management may continue to be sent where necessary.
          </p>
          ...
          <p>
            Information may be stored on cloud-based infrastructure, managed hosting environments, third-party business systems, or other authorized storage facilities. While we strive to maintain appropriate security measures, no method of electronic transmission or storage can be guaranteed to be completely secure.
          </p>
          ...
          <p>
            This Privacy Policy is intended to comply with applicable laws and regulations, including data protection laws, information technology laws, relevant rules framed thereunder, and applicable consumer protection and eCommerce regulations.
          </p>

          <h3 className="font-semibold text-base text-gray-900">15. Cross-Border Data Transfers</h3>
          <p>
            Certain technology providers, infrastructure partners, or service providers engaged by us may process or store information on servers located outside your country of residence. By using the Platform, users acknowledge and consent to such processing where necessary for providing services, subject to reasonable safeguards and applicable legal requirements.
          </p>
